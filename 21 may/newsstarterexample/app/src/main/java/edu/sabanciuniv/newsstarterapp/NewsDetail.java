...
public class NewsDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgNewsDet= (ImageView) findViewById(R.id.imgNewsDetail);
        txtNewsDetTitle= (TextView) findViewById(R.id.txtNewsDetailTitle);
        txtNewsDetBody= (TextView) findViewById(R.id.txtNewsDetailBody);
