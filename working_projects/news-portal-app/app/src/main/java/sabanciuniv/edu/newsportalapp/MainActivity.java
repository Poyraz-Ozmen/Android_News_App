                ...
                spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        switch(position) {
                            case 0:
                                GetAllNews tsk = new GetAllNews();
                                tsk.execute("https://94.138.207.51:8080/NewsApp/service/news/getall"); // Choosing all
                                break;
                            case 1:
                                categoryid = 4;
                                gnbc_tsk.execute("https://94.138.207.51:8080/NewsApp/service/news/getbycategoryid/"+categoryid+"");
                                break;
                            case 2:
                                categoryid = 6;
                                gnbc_tsk.execute("https://94.138.207.51:8080/NewsApp/service/news/getbycategoryid/"+categoryid+"");
